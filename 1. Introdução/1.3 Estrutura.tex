...
\begin{itemize}
    ...
    \item \textbf{Capítulo 3 – Fundamentação Teórica}: apresenta os conceitos essenciais que sustentam a pesquisa, incluindo a caracterização da irradiância solar, os índices de claridade atmosférica, variáveis sazonais e climáticas, bem como a descrição dos algoritmos de previsão considerados (como ARIMA, LSTM e XGBoost). O capítulo busca fornecer a base conceitual necessária para a compreensão da metodologia.
