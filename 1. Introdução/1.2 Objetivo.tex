...
\begin{itemize}
    \item Avaliar diferentes arquiteturas de modelagem, incluindo redes neurais recorrentes (LSTM e variações), modelos híbridos (ARIMA--LSTM) e modelos baseados em árvores (XGBoost).
    ...
    \item Investigar a influência de diferentes tamanhos de janelas de entrada (\textit{input window}), verificando sua contribuição para a qualidade preditiva.
