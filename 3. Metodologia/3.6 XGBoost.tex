...
Optar-se-á por não normalizar as variáveis por três razões práticas: (i) modelos de árvores serão pouco sensíveis à escala, (ii) preservar-se-á a interpretabilidade física em unidades originais ao longo do pipeline e (iii) evitar-se-á potencial viés de \textit{leakage} na aplicação de transformações dependentes do conjunto. A estratégia direta com $H$ modelos oferecerá ganhos de especialização por horizonte (curto vs.\ longo prazo) e evitará o acúmulo de erro típico de abordagens recursivas.
