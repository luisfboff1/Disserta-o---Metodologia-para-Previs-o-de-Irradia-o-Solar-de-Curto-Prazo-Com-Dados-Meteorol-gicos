...
\input{1. Introdução/1.1 Motivação}

\input{1. Introdução/1.2 Objetivo}
\input{1. Introdução/1.3 Estrutura}
...
\input{2. Revisão Bibliográfica/2.1 Estado da arte}

\chapter{Fundamentação teórica}\label{chap:fundamentação}

\input{2. Revisão Bibliográfica/2.2 Irradiancia}
\input{2. Revisão Bibliográfica/2.3 Variaveis meterologicas}
\input{2. Revisão Bibliográfica/2.4 HEMS}
\input{2. Revisão Bibliográfica/2.5 Metodos previsão}
...
\input{3. Metodologia/3.1 Seleção da base de dados}
\input{3. Metodologia/3.2 Pré processamento de dados}
\input{3. Metodologia/3.3 Análise de dados}
\input{3. Metodologia/3.4 Modelgaem}
\input{3. Metodologia/3.5 LSTM}
\input{3. Metodologia/3.6 XGBoost}
\input{3. Metodologia/3.8 Otimização}



\chapter{Estudo de caso}\label{chap:resultados}
\input{4. Estudo de Caso/4.1 Estudo de caso}
\input{4. Estudo de Caso/4.2 Análise de Dados}
...
\input{5. Resultados/5.1 ARIMA}

\input{5. Resultados/5.1 Modelo LSTM}
\input{5. Resultados/5.2 Modelo XGboost}
\input{5. Resultados/5.3 Comparação entre LSTM e XGBoost.tex}
